...
fit_min_log_P50 <- readRDS("data/model_objects/fit_min_log_P50.rds")
fit_max_log_P50 <- readRDS("data/model_objects/fit_max_log_P50.rds")
fit_mean_log_P50 <- readRDS("data/model_objects/fit_mean_log_P50.rds")
...
ggsave("figures/figure2/log_P50_lm.pdf", width = 15, height = 4.5, units = "in")

##---------------------------------------------------------------
## a max prediction plots
##---------------------------------------------------------------

fit_min_am <- readRDS("data/model_objects/fit_min_am.rds")
fit_max_am <- readRDS("data/model_objects/fit_max_am.rds")
fit_mean_am <- readRDS("data/model_objects/fit_mean_am.rds")
...
ggsave("figures/figure2/am_lm.pdf", width = 15, height = 4.5, units = "in")
