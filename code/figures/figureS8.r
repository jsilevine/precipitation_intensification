...
write.csv(unq_loc, "data/topo/location_topo_3km.csv")
...
ggsave("figures/figureS8/figureS8a.png", width = 12, height = 4)
...
write.csv(unq_loc, "data/topo/location_topo_1km.csv")
...
plot_grid(a, b, c, nrow = 1)
ggsave("figures/figureS8/figureS8b.png", width = 12, height = 4)
...
write.csv(unq_loc, "data/topo/location_topo_5km.csv")
...
plot_grid(a, b, c, nrow = 1)
ggsave("figures/figureS8/figureS8c.png", width = 12, height = 4)
