...
fit_min_log_P50 <- readRDS("data/model_objects/fit_min_log_P50_sens.rds")
fit_max_log_P50 <- readRDS("data/model_objects/fit_max_log_P50_sens.rds")
fit_mean_log_P50 <- readRDS("data/model_objects/fit_mean_log_P50_sens.rds")
...
ggsave("figures/sensitivity/log_P50_lm_sens.pdf", width = 15, height = 4.5, units = "in")

##---------------------------------------------------------------
## a max prediction plots
##---------------------------------------------------------------

fit_min_am <- readRDS("data/model_objects/fit_min_am_sens.rds")
fit_max_am <- readRDS("data/model_objects/fit_max_am_sens.rds")
fit_mean_am <- readRDS("data/model_objects/fit_mean_am_sens.rds")
...
ggsave("figures/sensitivity/am_lm_sens.pdf", width = 15, height = 4.5, units = "in")
